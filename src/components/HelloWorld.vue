<template>
  <div>
        ...
        <div class="container">
          ...
          <div class="col-sm-9">
            <ul class="nav nav-pills pull-right">
              ...
              <li class="cart-link"><a href="cart.html"><i aria-hidden="true" class="fa fa-money"></i>
                Launch Now</a></li>
            </ul>
          </div>
        </div>
    ...
    <section>
      <div class="row full-width no-gutter section_sapce cover-image"
           style="background: #02213e url(/static/images/slider/9.jpeg);">
        <div class="container">
          <div class="col-sm-12 col-md-6 custom-info4-column radius">
            <div class="thequote">
              <h5 class="text_dark">Create your <br/>Crypto Currency today</h5>
              <p class="text_dark">Cryptochains aims to make block chain and crypto technology pioneered by Bitcoin more accessible in India.</p>
              <a href="#" class="btn btn-lg btn-new">Launch Now</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="col-lg-4 margin-t30">
            <div class="text-center">
              ...
              <p>
                Vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti.</p>
            </div>
          </div>
          <div class="col-lg-4 margin-t30">
            <div class="text-center">
    ...
    <!--  Call to Action -->
    <section class="calltoaction section_sapce cover-image" data-image-src="/static/images/subbanners/4.jpg">
      <div class="row">
        <div class="container">
          <div class="col-sm-12 col-md-8 center-block">
            <div class="row no-gutter cta-content">
              <div class="offerdescription">
                <h2 class="text-uppercase  text-center">Hosting with FREE domain. </h2>
                <p class=" text-center">We are Providing Free Domain for every month new extentions.</p>
              </div>
            </div>
            <form class="form-inline domainsearch" method="post" action="#">
              <div class="row no-gutter">
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="sld"
                         onFocus="if (this.value == 'Enter your domain') {this.value = '';}"
                         onBlur="if (this.value == '') {this.value = 'Enter your domain';}" value="Enter your domain"/>
                </div>
                <div class="col-sm-2">
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-footer">
                <div class="btn-group btn-block margin-bottom-15">
                  <button type="button" class="btn btn-lg btn-default dropdown-toggle text-right"
                          data-toggle="dropdown">1 Mo <b class="text_primary">@ $345 /mo</b> <span class="caret"></span>
                  </button>
    ...
    <!--  Subscribe -->
    <section class="subscribe section_sapce2 bg_dark cover-image" data-image-src="/static/images/subbanners/2.jpg">
      <div class="row">
          ...
          <div class="col-sm-12">
            <div id="mc_embed_signup">
              <form class="form-inline validate"
                    action="//sreethemes.us9.list-manage.com/subscribe/post?u=f86de306ae229d9cca9373ff6&id=44e7c219bf"
                    method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank"
                    novalidate>
                <div class="row no-gutter">
                  <div class="col-sm-8 center-block margin-bottom-15">
                    <input type="email" value="" name="EMAIL" class="form-control text-center" id="mce-EMAIL"
        ...
        <div class="container">
          <div class="col-sm-12">
            <div id="datacenter-partners">
              <div class="item"><img src="/static/images/clients/1.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/2.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/3.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/4.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/5.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/6.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/7.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/8.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/9.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/1.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/2.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/3.png" alt=""></div>
              <div class="item"><img src="/static/images/clients/4.png" alt=""></div>
    ...
    <section class="statistics section_sapce">
      ...
      <div class="row">
        <div class="container">
          <div class="col-sm-6 col-md-3 margin-top-30">
            <div>
              <p id="myStat1" data-dimension="175" data-animationstep="0.5" data-text="3215" data-width="25"
                 data-fontsize="29" data-percent="64" data-fgcolor="#1a1a1a" data-bgcolor="#ebebeb"></p> <span>Hosting Servers</span>
            </div>
          </div>

          <div class="col-sm-6 col-md-3 margin-top-30">
            <div>
              <p id="myStat2" data-dimension="175" data-animationstep="0.5" data-text="4576" data-width="25"
                 data-fontsize="29" data-percent="46" data-fgcolor="#1a1a1a" data-bgcolor="#ebebeb"></p> <span>All Customers</span>
            </div>
          </div>

          <div class="col-sm-6 col-md-3 margin-top-30">
            <div>
              <p id="myStat3" data-dimension="175" data-animationstep="0.5" data-text="3246" data-width="25"
                 data-fontsize="29" data-percent="38" data-fgcolor="#1a1a1a" data-bgcolor="#ebebeb"></p> <span>Total Employees</span>
            </div>
          </div>

          <div class="col-sm-6 col-md-3 margin-top-30">
            <div>
              <p id="myStat4" data-dimension="175" data-animationstep="0.5" data-text="1564" data-width="25"
                 data-fontsize="29" data-percent="55" data-fgcolor="#1a1a1a" data-bgcolor="#ebebeb"></p> <span>Happy Clients</span>
            </div>
          </div>
            ...
            <div id="testimonials-carousel" class="owl-carousel">
              ...
              <div class="item">
                <div class="testimonial-content">
                  <div class="testimonialimg"><img src="/static/images/testimonial1.jpg" alt=""/></div>
                  <p>
              ...
              <div class="item">
                <div class="testimonial-content">
                  <div class="testimonialimg"><img src="/static/images/testimonial2.jpg" alt=""/></div>
                  <p>
              ...
              <div class="item">
                <div class="testimonial-content">
                  <div class="testimonialimg"><img src="/static/images/testimonial3.jpg" alt=""/></div>
                  <p>
                    There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum</p>
                  <div class="whoclient">
    ...
    <section class="container section_sapce">
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 margin-top-30">
        <div class="service-icon"><i aria-hidden="true"
                                     class="fa fa-sitemap fa-5x text_primary square-border-icon center-block"></i> <span
          class="service-text">Shared Hosting</span></div>
      </div>
      <div class="col-md-2 col-sm-4 col-xs-6 margin-top-30">
        <div class="service-icon"><i aria-hidden="true"
                                     class="fa fa-server fa-5x text_primary square-border-icon center-block"></i> <span
          class="service-text">VPS Hosting</span></div>
      </div>
      <div class="col-md-2 col-sm-4 col-xs-6 margin-top-30">
        <div class="service-icon"><i aria-hidden="true"
                                     class="fa fa-desktop fa-5x text_primary square-border-icon center-block"></i> <span
          class="service-text">Dedicated Hosting</span></div>
      </div>
      <div class="col-md-2 col-sm-4 col-xs-6 margin-top-30">
        <div class="service-icon"><i aria-hidden="true"
                                     class="fa fa-windows fa-5x text_primary square-border-icon center-block"></i> <span
          class="service-text">Windows Hosting</span></div>
      </div>
      <div class="col-md-2 col-sm-4 col-xs-6 margin-top-30">
        <div class="service-icon"><i aria-hidden="true"
                                     class="fa fa-cloud fa-5x text_primary square-border-icon center-block"></i> <span
          class="service-text">Cloud Hosting</span></div>
      </div>
      <div class="col-md-2 col-sm-4 col-xs-6 margin-top-30">
        <div class="service-icon"><i aria-hidden="true"
                                     class="fa fa-align-justify fa-5x text_primary square-border-icon center-block"></i>
          <span class="service-text">Reseller Hosting</span></div>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12">
            <div class="pop-video-container margin-t30">
              <!--Youtube Video Link-->
              <a class="autoplay" href="https://www.youtube.com/watch?v=RSbOZUfiGqg"><i class="fa fa-play fa-3x"
                                                                                        aria-hidden="true"></i></a>

              <!--Vimeo Video Link-->
              <!--<a class="autoplay" href="https://vimeo.com/35044232"><i class="fa fa-play fa-3x" aria-hidden="true"></i></a>-->
              <img src="/static/images/play-video.png" alt="" class="macbook">
            </div>
          </div>
        </div>
      </div>
    ...
    <!--APPS Downloads -->
    <section class="section_sapce bg_dark section-parallax parallax cover-image apps-download"
             data-image-src="/static/images/parallax/04.jpg">
      <div class="container ">
        <div class="row">
          <div class="section-title  margin-b50">
              ...
              <div class="prices row">
                <div class="col-sm-4 col-md-3">
                  <div class="domain-p-container relative">
                    ...
                    <p class="text_primary">FREE<span class="through-line">$12.25</span>
                      <small class="text_danger" id="limited"></small>
                    </p>
                  </div>
                </div>
                <div class="col-sm-4 col-md-3">
                  <div class="domain-p-container">
                    <h4>.US</h4>
                    <p>$0.1 <span class="through-line">$12.50</span>
                      <small>Ends 2017-07-31</small>
                    </p>
                  </div>
                </div>
                <div class="col-sm-4 col-md-3">
                  <div class="domain-p-container">
                    <h4>.BIZ</h4>
                    <p>$3.01 <span class="through-line">$15.80</span>
                      <small>Ends 2017-07-31</small>
                    </p>
                  </div>
                </div>
                <div class="col-sm-4 col-md-3">
                  <div class="domain-p-container">
                    <h4>.IN</h4>
                    <p>$5.22 <span class="through-line">$10.16</span>
                      <small>Ends 2017-07-31</small>
                    </p>
                  </div>
                </div>
                <div class="col-sm-4 col-md-3">
                  <div class="domain-p-container">
                    <h4>.ORG</h4>
                    <p>$2.39 <span class="through-line">$13.21</span>
                      <small>Ends 2017-07-31</small>
                    </p>
                  </div>
                </div>
                <div class="col-sm-4 col-md-3">
                  <div class="domain-p-container">
                    <h4>.CO</h4>
                    <p>$8.22 <span class="through-line">$16.21</span>
                      <small>Ends 2017-07-31</small>
                    </p>
                  </div>
                </div>
          ...
          <div class="col-sm-12">
            <div id="shared-hosting-features-tabs">
              <ul>
                ...
                <li><a href="#feature2"><i class="fa fa-mouse-pointer" aria-hidden="true"></i> just 1 click Install </a>
                </li>
                    ...
                    <div class="col-sm-12">
                      <div class="block-grid-sm-4 block-grid-xs-2 apps">
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/01.png" alt=""/>
                        </div>
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/02.png" alt=""/>
                        </div>
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/03.png" alt=""/>
                        </div>
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/04.png" alt=""/>
                        </div>
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/05.png" alt=""/>
                        </div>
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/06.png" alt=""/>
                        </div>
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/07.png" alt=""/>
                        </div>
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/08.png" alt=""/>
                        </div>
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/09.png" alt=""/>
                        </div>
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/10.png" alt=""/>
                        </div>
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/11.png" alt=""/>
                        </div>
                        <div class="col-sm-6 col-md-3 col-xs-12 margin-t30">
                          <img src="/static/images/apps/12.png" alt=""/>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="faq-questions margin-t50">
                        <div id="accordion" class="panel-group">
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                                         href="#collapse2">Can I host multiple Web sites within one Hosting plan?</a>
                              </h4></div>
                            <div id="collapse2" class="panel-collapse collapse">
                              <div class="panel-body">
                                <p>
                                  FRaise awareness maintain; peace social worker; tackling; Rosa Parks global citizens globalization social impact. Healthcare pride, change movements disruption; democratizing the global financial system gender equality. Network natural resources, think tank elevate civic engagement.</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                                         href="#collapse3">How to Secure Hosting Server and website ?</a>
                              </h4></div>
                            <div id="collapse3" class="panel-collapse collapse">
                              <div class="panel-body">
                                <p>
                                  Grantees dedicated; inspire social change; truth support engage. Global breakthrough insights readiness democracy crisis situation honesty amplify volunteer combat poverty indicator.</p>
                                <p>
                                  Catalytic effect hack agriculture many voices aid challenges. Rural; social good minority humanitarian relief vulnerable citizens. Country, action 501(c)(3) collaborative cities carbon emissions reductions; affordable health care social analysis detection agenda Kony 2012 inclusive fight against malnutrition. Campaign Ford Foundation respond billionaire philanthropy, compassion economic development legal aid medical supplies advocate fighting poverty stakeholders technology Action Against Hunger. </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                                         href="#collapse4">Who do I get in touch with if I need help ?</a>
                              </h4></div>
                            <div id="collapse4" class="panel-collapse collapse">
                              <div class="panel-body">
                                <p>
                                  Metrics immunize tackling courageous opportunity safeguards dignity Cesar Chavez peace recognition free-speech measures innovate. Complexity, fellows NGO, livelihoods, initiative. Criteria employment country The Elders, global leaders; care social entrepreneurship; inclusive capitalism gender.</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                                         href="#collapse5">What is web hosting and WHMCS?</a></h4></div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                                         href="#collapse6">What is a control panel?</a></h4></div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                                         href="#collapse7">What are the charges if I exceed my bandwidth? </a>
                              </h4></div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                                         href="#collapse8">How can I Get Refund after 30 Days ? </a>
                              </h4></div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                                         href="#collapse9">How can I see my web site's Error logs and Raw Access logs?</a>
                              </h4></div>
    ...
    <!-- Counter Area Start -->
    <section class="counter section_sapce cover-image" data-image-src="/static/images/subbanners/counter-bg.jpg">
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-md-3 margin-top-30">
            <!-- Counter Item Start -->
